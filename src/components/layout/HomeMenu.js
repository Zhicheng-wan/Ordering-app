      ...
      <section className="py-2">
        <div className="container mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <a href="" className="text-black underline text-sm">More &gt;</a>
          </div>
            ...
            {products.map((product, index) => (
              ...
              >
                ...
                <div className="flex flex-col justify-between min-h-[80px]">
                  <h3 className="font-semibold mt-1 text-md px-2 overflow-hidden">
                    {product.title}
                  </h3>
                ...
                <div className="mt-auto pt-4">
                  <button
                    className="bg-primary items-center text-sm uppercase flex justify-center gap-2 text-white px-4 py-2 rounded-full font-semibold mx-auto"
                  >
                    Add to Bag
                  </button>
                </div>
